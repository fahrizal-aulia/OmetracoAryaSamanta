...
<div class="container">
    ...
    {{-- Form Update --}}
    <form action="{{ route('projectcontrol.pembelian.update', $pembelian->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('projectcontrol.pembelian.index') }}" class="btn btn-secondary mt-3">Batal</a>
    </form>
</div>
