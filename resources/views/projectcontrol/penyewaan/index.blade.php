...
<div class="container">
    ...
    {{-- Form Cari Proyek --}}
    <form action="{{ route('projectcontrol.penyewaan.index') }}" method="GET" class="d-flex mb-3" role="search">
    ...
    {{-- Tombol Tambah Data --}}
    <div class="mb-4">
        <a href="{{ route('projectcontrol.penyewaan.create') }}" class="btn btn-success">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-1">
                                <a href="{{ route('projectcontrol.penyewaan.view', $penyewaan->id) }}" class="btn btn-sm btn-info">
                                    <i class="bi bi-eye"></i> View
                                </a>
                                <a href="{{ route('projectcontrol.penyewaan.edit', $penyewaan->id) }}" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </a>
                                <form action="{{ route('projectcontrol.penyewaan.destroy', $penyewaan->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?');">
                                    @csrf
                                    @method('DELETE')
