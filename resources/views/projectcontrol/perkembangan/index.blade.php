...
<div class="main-content">
    <div class="container">
        ...
        <!-- Form Pencarian -->
        <form method="GET" action="{{ route('projectcontrol.perkembangan.index') }}" style="margin-bottom: 20px;">
            <input type="text" name="search" placeholder="Cari Nama Proyek..." value="{{ request('search') }}">
            <input type="date" name="tanggal_mulai" value="{{ request('tanggal_mulai') }}">
            <input type="date" name="tanggal_selesai" value="{{ request('tanggal_selesai') }}">
            <button type="submit" class="btn-search">Cari</button>
            <button type="button" class="btn-search reset" onclick="window.location.href='{{ route('projectcontrol.perkembangan.index') }}'">Reset</button>
        </form>
            ...
            <tbody>
                @forelse($proyeks as $index => $proyek)
                    <tr>
                        ...
                        <td class="action">
                            <a href="{{ route('projectcontrol.perkembangan.upload', $proyek->id) }}" class="btn btn-upload">Upload</a>
                            <a href="{{ route('projectcontrol.perkembangan.update', $proyek->id) }}" class="btn btn-update">Update</a>
                            <a href="{{ route('projectcontrol.perkembangan.view', $proyek->id) }}" class="btn btn-view">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
