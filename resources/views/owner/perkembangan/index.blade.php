...
<div class="main-content">
    <div class="container">
        ...
        <!-- Form Pencarian -->
        <form method="GET" action="{{ route('owner.perkembangan.index') }}" style="margin-bottom: 20px;">
            <input type="text" name="search" placeholder="Cari Nama Proyek..." value="{{ request('search') }}">
            <input type="date" name="tanggal_mulai" value="{{ request('tanggal_mulai') }}">
            <input type="date" name="tanggal_selesai" value="{{ request('tanggal_selesai') }}">
            <button type="submit" class="btn-search">Cari</button>
            <button type="button" class="btn-search reset" onclick="window.location.href='{{ route('owner.perkembangan.index') }}'">Reset</button>
        </form>
                ...
                @forelse($proyeks as $index => $proyek)
                    <tr>
                        ...
                        <td class="action">
                            ...
                            <a href="{{ route('owner.perkembangan.view', $proyek->id) }}" class="btn btn-view">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
