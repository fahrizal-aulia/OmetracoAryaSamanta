            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex gap-1">
                        ...
                        <a href="{{ route('pembelian.bahan', ['id' => $item->proyek_id, 'week' => 1]) }}"
                            class="btn btn-sm btn-outline-primary">
                            <i class="bi bi-eye"></i> View
                        </a>
                        <form action="{{ route('pembelian.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pembelian ini?');">
                            @csrf
                            @method('DELETE')
