...
<div class="main-content">
    <div class="container">
        ...
        <div style="margin-bottom: 20px; text-align: left;">
            <a href="{{ route('kontraktors.create') }}" class="btn">+ Tambah Kontraktor</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('kontraktors.destroy', $k->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="action-btn btn-delete" onclick="return confirm('Yakin ingin menghapus kontraktor ini?')">Hapus</button>
                        </form>
                    </td>
                </tr>
                @endforeach
