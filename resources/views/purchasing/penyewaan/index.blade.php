...
<div class="container">
    ...
    {{-- Form Cari Proyek --}}
    <form action="{{ route('purchasing.penyewaan.index') }}" method="GET" class="d-flex mb-3" role="search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-1">
                                <a href="{{ route('purchasing.penyewaan.view', $penyewaan->id) }}" class="btn btn-sm btn-info">
                                    <i class="bi bi-eye"></i> View
                                </a>
                                <a href="{{ route('purchasing.penyewaan.edit', $penyewaan->id) }}" class="btn btn-sm btn-warning">
