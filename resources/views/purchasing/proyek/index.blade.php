...
<div class="sidebar" id="sidebar">
    <h2>Menu</h2>
    <a href="{{ route('purchasing.dashboard') }}">Dashboard</a>
    <a href="{{ route('purchasing.proyek.index') }}">Data Proyek</a>
    <a href="{{ route('purchasing.pembelian-bahan') }}">Pembelian Bahan Material</a>
...
<div class="main-content" id="main-content">
    <div class="container">
        ...
        <form method="GET" action="{{ route('purchasing.proyek.index') }}" style="margin-bottom: 20px;">
            <input type="text" name="search" placeholder="Cari Nama Proyek..." value="{{ request('search') }}">
            <input type="date" name="tanggal_mulai" value="{{ request('tanggal_mulai') }}">
            <input type="date" name="tanggal_selesai" value="{{ request('tanggal_selesai') }}">
            <button type="submit" class="btn-search">Cari</button>
            <button type="button" class="btn-search reset" onclick="window.location.href='{{ route('purchasing.proyek.index') }}'">Reset</button>
        </form>
