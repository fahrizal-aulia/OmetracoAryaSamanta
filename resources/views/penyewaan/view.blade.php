...
<div class="container">
    ...
    <div class="d-flex justify-content-end mb-4">
        <form action="{{ route('penyewaan.show', $penyewaan->id) }}" method="GET" class="d-flex align-items-center">
    ...
    {{-- Tombol Kembali --}}
    <div class="mt-4">
        <a href="{{ route('penyewaan.index') }}" class="btn btn-outline-secondary">← Kembali</a>
    </div>
</div>
@endsection
